...
//		System.out.println("첫번째 집 : " + num1[1]);
...
//		String str = " ";
		...
		char[] ch1 = { '훈', '짱' }; // 문자(하나) 입력시 ''싱글쿼터 사용
		String[] str1 = { "인덱스0", "인덱스1", "인덱스2" }; // 문자(2개이상) ""더블쿼터 사용

		System.out.println("String 타입에서 2번째 집에 저장된 값 : ");
		...
		// for문을 이용해서 num3배열에 저장 된 갑을 모두 출력
		// i=0, length사용
		...
		System.out.println("numbers 의 총점 : " + sum);
		System.out.println("numbers 의 평균 : " + avg);
